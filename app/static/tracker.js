      ...
      map.on('singleclick', function(evt) {
        ...
        if (feature) {   
            ...
            element.popover({
              ...
              'content':  "<div class='sat'> <b>Latitude: </b> ".concat(latitude.toFixed(4)) + "º<br><b>Longitude: </b>".concat(longitude.toFixed(4)) + "º<br><b>Elevation: </b>".concat((elevation/1000).toFixed(0)) + " km</div>"
            }).popover('show');
        }
      });
...
function updateCoords() {
    $.ajax({
        ...
        success: function(data) {
            ...
            tooltip_data = "<div class='sat'> <b>Latitude: </b> ".concat(latitude.toFixed(4)) + "<br><b>Longitude: </b>".concat(longitude.toFixed(4)) + "<br><b>Elevation: </b>".concat(elevation) + "</div>";
        },
            error: function() {
